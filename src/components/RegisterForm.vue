    ...
    <div>
        ...
        <vee-form :validation-schema="schema"
            @submit="register" :initial-values="userData">
                ...
                <vee-field name="age" v-slot="{field, errors}" :bails="false">
                    <input type="number" class="block w-full py-1.5 px-3 text-gray-800 border
                    border-gray-300 transition duration-500 focus:outline-none
                    focus:border-black rounded" v-bind="field"  />
                ...
                <button type="submit" :disabled="reg_in_submition"
...
export default {
  ...
  data() {
    return {
      ...
      reg_alert_message: 'pls wait! your account is being created.',
    };
  },
  methods: {
    async register(values) {
      ...
      this.reg_alert_message = 'pls wait! your account is being created.';
